<?php return [
    'plugin' => [
        ...
        'form_color_override' => 'Override Farbe für Titel',
    ...
    'communicate' => [
        ...
        'status' => 'Status',
        'date' => 'Datum',
        'mainmenu' => 'Kontaktformulare Flnx',
        'submenu' => 'Blocks',
        'submenu1' => 'Inbox',
        'permission' => 'Simple Contact',
        'permission_messages' => 'Nachrichten',
        'permission_settings' => 'Einstellungen',
        'phone' => 'Telefon',
        'message' => 'Nachricht',
        'reply' => 'Antworten',
        'print' => 'Print',
        ...
        'message_reply_success' => 'Nachricht erfolgreich versendet.',
        'message_reply' => 'Reply Message',
        'button_submit_reply' => 'Senden',
        'button_close_reply' => 'Schliessen',
    ],
    'settings' => [
