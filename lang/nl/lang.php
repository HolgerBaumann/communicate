<?php return [
    'plugin' => [
        'name' => 'Communicate',
        'description' => 'Een makkelijk communicateformulier.',
    ],
    'communicate' => [
        'from' => 'Van',
        'subject' => 'Onderwerp',
    ...
    'settings' => [
        'section_communicate_label' => 'Instellingen',
        ...
        'notification_comment' => 'Verzend een e-mail notificatie als communicate formulier is verzonden.',
        ...
        'section_recaptcha_comments' => 'Toon of verberg reCAPTCHA in communicateformulier',
        'recaptcha_label' => 'reCAPTCHA',
        'recaptcha_comment' => 'Toon reCAPTCHA widget op communicateformulier',
    ...
    'component' => [
        'name' => 'Simpel Communicateformlier',
        'description' => 'Voeg communicateformulier toe aan webpagina.',
